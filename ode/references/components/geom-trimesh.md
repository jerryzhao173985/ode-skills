...
- Passing `double[3]` data to `dGeomTriMeshDataBuildSingle` (or vice versa) produces garbage geometry — the function name, not `dReal`, decides how the bytes are read.
